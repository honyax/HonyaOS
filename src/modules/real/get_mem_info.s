...
.10L:
        ...
        ; コマンドに対応か？
        cmp     eax, 'PAMS'                     ;
        je      .12E                            ; if ('SMAP' == EAX) goto .12E;
        jmp     .10E                            ; goto .10E;

.12E:
        ; エラー無し？                           ;
        jnc     .14E                            ; if (!CF) goto .14E;
        jmp     .10E                            ; goto .10E;
...
.15E:
        cmp     ebx, 0
        jz      .16E                            ; if (EBX == 0) goto .16E

        inc     bp                              ; lines++;
        and     bp, 0x07                        ; lines &= 0x07;
        jnz     .16E                            ; if (lines != 0) goto .16E
