...
;************************************************************************
		...
		;           |____________| 
		; 0010_3000 |      (20K) | カーネルプログラム
		;           =            = 
		;           |            | 
		;           |____________| 
		; 0010_8000 |       (4K) | カーネルページディレクトリ
		;           |____________| 
		; 0010_9000 |     (132K) | カーネルページテーブル（先頭128MB + VRAM 4MB）
		;           =            = 
		;           |            | 
		;           |____________| 
		; 0012_A000 |////////////|
        ...
        KERNEL_PAGE_DIR     equ     0x0010_8000     ; カーネルのページディレクトリ
        KERNEL_PAGE_TABLE   equ     0x0010_9000     ; カーネルのページテーブル
        HEAP_MEMORY_START   equ     0x0020_0000     ; ヒープメモリの開始位置
